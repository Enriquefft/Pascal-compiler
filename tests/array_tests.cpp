...
//       ";"}, {TT::Begin, "begin"},     {TT::For, "for"}, {TT::Identifier,
//       "i"}, {TT::Colon, ":"},         {TT::Assign, "="},        {TT::Number,
//       "1"}, {TT::To, "to"},           {TT::Number, "5"},        {TT::Do,
//       "do"}, {TT::Identifier, "a"},    {TT::LeftBracket, "["},
//       {TT::Identifier, "i"}, {TT::RightBracket, "]"},  {TT::Colon, ":"},
